...
| `MASTER_GRPC_PORT` | `50051` | gRPC server port (workers connect here) |
| `MAX_QUEUE_SIZE` | `5000` | Max tasks in queue before rejecting new requests |

### Worker Agent
| Variable | Default | Description |
|----------|---------|-------------|
| `MASTER_GRPC_URL` | required | Master gRPC address (e.g., `192.168.1.10:50051`) |
...
| `WORKER_HTTP_PORT` | `8001` | Prometheus metrics HTTP port |
| `WORKER_GRPC_PORT` | `50052` | gRPC server port (Master calls here for inference) |
